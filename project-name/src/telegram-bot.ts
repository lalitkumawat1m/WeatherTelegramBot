...
export class TelegramBotService {
  ...
  private registerCommands() {
    ...
    this.bot.onText(/\/start/, async(msg)=>{
      ...
      this.bot.sendMessage(chatId, `Hi ${first_name}, welcome to the coldweather bot, you can subscribe by using the /subscribe command, and unsubscribe using /unsubscribe command}`)
